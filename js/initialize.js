...
(async () => {
    ...
    let adminAddress = admin.address().hexString

    const payload = {
        function: adminAddress + "::" + moduleName + "::" + "initialize",
        type_arguments: [],
        arguments: [],
    ...
    const txnRequest = await client.generateTransaction(admin.address(), payload, option);
